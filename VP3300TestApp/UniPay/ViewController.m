...
- (void)viewDidLoad
{
    ...
    //init object
#ifndef __i386__
    //CLEARENT: Initialize the clearentVP3300 object with your public delegate. In this example, the ViewController is your delegate (Clearent_Public_IDTech_VP3300_Delegate).
...
- (void) exampleUseJwtToRunPaymentTransaction:(NSString*)token {
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    else
    {
        ...
        [self appendMessageToResults:@"[[VP3300 sharedController] Open Failed]"];
    }
}
